...
class Maze:
    ...
    def _solve_r(self, i, j):
        ...
        if i == self.num_rows-1 and j == self.num_cols-1:
            return True
        if i - 1 >= 0 and current_cell.has_top_wall == False and self._cells[i-1][j].visited == False:
        ...
        if j + 1 <= self.num_cols-1 and current_cell.has_right_wall == False and self._cells[i][j+1].visited == False:
            ...
            if self._solve_r(i, j+1) == True:
                ...
                current_cell.draw_move(next_cell, undo=True)
        if i + 1 <= self.num_rows-1 and current_cell.has_bottom_wall == False and self._cells[i+1][j].visited == False:
            next_cell = self._cells[i+1][j]
            current_cell.draw_move(next_cell)
            if self._solve_r(i+1, j) == True:
                return True
                ...
                current_cell.draw_move(next_cell, undo=True)
        if j - 1 >= 0 and current_cell.has_left_wall == False and self._cells[i][j-1].visited == False:
            next_cell = self._cells[i][j-1]
            current_cell.draw_move(next_cell)
            if self._solve_r(i, j-1) == True:
                return True
